...
import { signIn, signInWithGoogle, signInWithApple } from "../actions";
  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      <div className="space-y-3">
        ...
        {/* Apple Sign In - Temporarily hidden until Apple Developer account is configured */}
        {/* <button
          type="button"
